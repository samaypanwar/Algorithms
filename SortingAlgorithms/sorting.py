...
class Sort:
    ...
    def quick_sort(self, array):
        ...
        # The equals sign is there to take repeated elements into consideration
    ...
    def heap_sort(self, array):
        ...
        def remove_minimum_from_heap(heap):
            ...
            while heap[elementIndex] > heap[minimumChildIndex]: # While the parent is bigger than its smallest child, swap
